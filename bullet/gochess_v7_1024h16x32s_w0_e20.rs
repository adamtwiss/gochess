...
20 SB validation run with checkpoint at SB10 and SB20.
*/
use bullet_lib::{
    game::{
...
fn main() {
    ...
    let mut trainer = ValueTrainerBuilder::default()
        ...
        .save_format(&[
            ...
            // l2: Second hidden layer weights and biases (NEW)
    ...
    let schedule = TrainingSchedule {
        net_id: "gochess-v7-1024h16x32s-w0-e20".to_string(),
