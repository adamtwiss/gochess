...
var passedPawnMG = [8]int{0, -3, -26, -17, 15, 57, 130, 0} // by rank (0=rank1, 7=rank8)
var passedPawnEG = [8]int{0, -14, 13, 25, 63, 139, 253, 0}
...
var pawnAdvancementMG = [8]int{0, 14, 20, 30, 41, 52, 110, 0}
var pawnAdvancementEG = [8]int{0, 64, 51, 56, 89, 94, 138, 0}

// Candidate passed pawn: no enemy pawn ahead on own file, friendly support >= enemy sentries
var candidatePassedMG = [8]int{0, -2, 3, 5, 3, -5, 0, 0}
var candidatePassedEG = [8]int{0, -7, 15, 45, 78, 234, 0, 0}
var CandidatePassedEnabled = true

// Pawn majority: bonus per pawn advantage on a wing (queenside/kingside)
var PawnMajorityMG = 10
var PawnMajorityEG = 1
...
var queensidePawnAdvMG = [8]int{0, -17, 7, 6, 15, 4, 39, 0}
var queensidePawnAdvEG = [8]int{0, 23, 16, 29, 36, 47, 37, 0}
...
var pawnLeverMG = [8]int{0, 8, -5, -6, -6, 5, 0, 0}
var pawnLeverEG = [8]int{0, -7, 10, 6, -8, 3, 0, 0}
...
var (
	shieldPawnRank2MG          = 22
	shieldPawnRank3MG          = 13
	missingShieldPawnMG        = -10
	missingShieldPawnAdvancedMG = -1
